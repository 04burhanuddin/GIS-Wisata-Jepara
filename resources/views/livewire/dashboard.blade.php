<div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
    ...
    <div class="container">
        ...
        <P class="text-center mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vulputate auctor vestibulum
            mi
            varius ornare rutrum
            consectetur
            volutpat consectetur.
            Proin
            et eget consequat scelerisque. Diam sed lobortis vel amet lectus. Ac tortor, ut lacus interdum molestie
            lectus
            nisi, tellus velit.</P>
        <div class="card-deck">
            <div class="card">
        ...
        <div class="container gx-4" id="contact">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="row row-cols-1 row-cols-lg-3 py-5 justify-content-center">
                    <div class="col">
                        <p class="mb-4 text-white fs-6 mt-0 mb-sm-3 opacity-75">Mitra Terpercaya Menuju Koperasi Yang
                            Sehat,
                            Kuat,
